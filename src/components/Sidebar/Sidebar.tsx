...
import { FolderIcon, NoteIcon, PushPinIcon, PencilSimpleIcon, TrashIcon } from '@phosphor-icons/react';
                ...
                <div key={folder.id} className="sidebar-folder">
                  {isEditing ? (
                    <div className="sidebar-folder-row is-editing" onClick={e => e.stopPropagation()} onPointerDown={e => e.stopPropagation()}>
                      ...
                      <span className="sidebar-folder-icon"><FolderIcon size={14} weight="duotone" color="var(--amber)" aria-hidden="true" /></span>
                      <input
                        ref={inputRef}
                    ...
                    >
                      ...
                      >
                        <PushPinIcon size={13} weight={folder.pinned ? 'fill' : 'regular'} aria-hidden="true" />
                      </button>
                      <button
                        className="sidebar-icon-btn"
                        onClick={e => {
                        ...
                        pages.map(page => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <PushPinIcon size={13} weight={page.pinned ? 'fill' : 'regular'} aria-hidden="true" />
                              </button>
                              <button
                                className="sidebar-icon-btn"
                                onClick={e => {
