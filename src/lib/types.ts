...
export type Node = { id:string; doc?: TiptapDoc | null; content:string; parentId:string|null; position:Position; status:Status; isCollapsed:boolean; tint?: string | null; style?: NodeStyle; size?: NodeSize | null; presentationOrder?: number; createdAt:number; updatedAt:number };
